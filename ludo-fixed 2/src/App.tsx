...
export default function App() {
  ...
  }, [multiplayer?.gameState?.updatedAt, multiplayer?.gameState?.hasRolled, multiplayer?.gameState?.diceValue, multiplayer?.gameState?.activePlayerColor, multiplayer?.gameState?.status, gameMode, myMultiplayerColor, players.length]);

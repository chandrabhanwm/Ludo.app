...
export default function App() {
  ...
  const handleRollDice = async () => {
    ...
    if (gameMode === 'online' && multiplayer) {
      console.log('[DICE] online roll attempt', {
        isMyTurn: multiplayer.isMyTurn,
        hasRolled,
        diceState,
        gameState: multiplayer.gameState ? {
          status: multiplayer.gameState.status,
          activeColor: multiplayer.gameState.activePlayerColor,
          myColor: myMultiplayerColor,
          hasRolled: multiplayer.gameState.hasRolled,
        } : null,
        myColor: myMultiplayerColor,
      });

...
export default function App() {
  ...
  // Auth state — starts as loading until Firebase resolves
  ...
  const endMatch = () => {
    ...
    if (hasHuman) {
      ...
      if (firebaseUser && !firebaseUser.isAnonymous) {
        ...
        Promise.all([
          saveStats(firebaseUser.uid, updatedStats),
          saveWallet(firebaseUser.uid, wallet),
          savePrestige(firebaseUser.uid, prestigeState),
          saveUnlockedRewards(firebaseUser.uid, unlockedRewards),
          saveGameHistory(firebaseUser.uid, updatedHistory),
          updateLeaderboard(
            firebaseUser.uid,

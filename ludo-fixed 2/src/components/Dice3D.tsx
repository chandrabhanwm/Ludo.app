...
export const Dice3D: React.FC<Dice3DProps> = ({
  ...
  // FIX: when diceState becomes 'rolled' and value has changed, update displayValue
  // This handles online mode where Firestore value arrives after animation starts
  useEffect(() => {
    if (diceState === 'rolled' && value !== displayValue) {

  ...
  const renderYard = (color: PlayerColor) => {
    ...
    return (
      <div className={`absolute ${positionClasses} w-[40%] h-[40%] z-10 select-none rounded-xl sm:rounded-[24px] transition-all duration-500 ${
        ...
        showYardGlow ? {
          red: 'ring-[3px] ring-rose-400 ring-offset-1 ring-offset-transparent z-30',
          green: 'ring-[3px] ring-emerald-400 ring-offset-1 ring-offset-transparent z-30',
          yellow: 'ring-[3px] ring-amber-400 ring-offset-1 ring-offset-transparent z-30',
          blue: 'ring-[3px] ring-sky-400 ring-offset-1 ring-offset-transparent z-30'
        }[color] : ''
      }`}>
        <div className={`${getYardWrapperClasses(color)} w-full h-full relative overflow-hidden rounded-xl sm:rounded-[24px] shadow-[inset_0_4px_10px_rgba(0,0,0,0.12),0_2px_4px_rgba(255,255,255,0.06)]`}>
          ...
          {/* Active Turn — subtle solid tint, only during roll phase */}
          {showYardGlow && (

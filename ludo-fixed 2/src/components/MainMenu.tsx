            ...
            <div className="relative overflow-hidden rounded-3xl"
              ...
              <div className="relative z-10 flex items-center justify-between px-5 pt-5 pb-2">
                {(() => {
                  ...
                  const playerName = userDisplayName || (typeof window !== 'undefined' && localStorage.getItem('ludo_player_name')) || 'Player';
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="relative">
                        ...
                        {userPhotoURL ? (
                          <img
                            src={userPhotoURL}
                            alt={playerName}
                            className="w-12 h-12 rounded-2xl object-cover relative"
                            style={{
                              border: hasDiamondFrame ? '2px solid #a8edea' : '2px solid rgba(245,158,11,0.4)',
                          ...
                          <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-xl font-black text-white relative overflow-hidden"
                            style={{
                              ...
                              boxShadow: '0 6px 18px rgba(234,88,12,0.4),inset 0 1.5px 3px rgba(255,255,255,0.55)',
                              zIndex: 1,
                              position: 'relative',
                            }}>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5">
                          <div className="text-[11px] font-black leading-tight truncate" style={{color: hasDiamondFrame ? '#1e3a8a' : '#92400e'}}>
                            {isGuest ? '👤 Guest' : playerName.split(' ')[0]}
                          </div>
                          {isGuest && (
                            <span className="text-[8px] font-bold px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-200 shrink-0">
                              Limited
                            </span>
                          )}
                        </div>
                        ...
                        {userEmail && !isGuest && (
                          <div className="text-[9px] text-stone-400 truncate mt-0.5">{userEmail}</div>
                        )}
                      </div>
                      ...
                      {onLogout && (
                        <button
                          ...
                          className="shrink-0 flex items-center gap-1 px-2.5 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-wider transition active:scale-95"
                          style={{
                            background: 'rgba(255,255,255,0.88)',
                            border: '1.5px solid rgba(180,120,60,0.22)',
                            color: isGuest ? '#15803d' : '#dc2626',
                            boxShadow: '0 2px 6px rgba(0,0,0,0.06)',
                          }}
                          title={isGuest ? 'Sign in with Google' : 'Sign out'}
                        >
              ...
              <div className="relative z-10 px-5 pb-4 grid grid-cols-2 gap-3">
                {([
                  ...
                  { label: 'Play Online', emoji: isGuest ? '🔒' : '🌐', from: '#c4b5fd', to: '#a78bfa', bottomColor: '#7c3aed', glow: 'rgba(124,58,237,0.35)', textDark: '#4c1d95', action: () => { audio.playClick(); onStartGameWithMode('online'); } },

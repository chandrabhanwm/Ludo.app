...
export const Dice3D: React.FC<Dice3DProps> = ({
  ...
  useEffect(() => {
    ...
    if (diceState === 'rolling') {
      ...
      controls.start({
        ...
        const bloomDuration = value === 6 ? 0.45 : 0.35;
        glowControls.start({
          opacity: [0, value === 6 ? 0.95 : 0.7, 0],
          scale: value === 6 ? [1, 1.25, 1] : [1, 1.15, 1],
  ...
  return (
    <div
      id="dice-container"
      className={`relative w-[76px] h-[76px] sm:w-[88px] sm:h-[88px] rounded-full flex items-center justify-center cursor-pointer bg-gradient-to-br from-[#dfd9ce]/45 to-white dark:from-[#131110] dark:to-[#211f1e] border border-[#dfd9ce] dark:border-[#2b2725] border-b-[2px] border-r-[1px] shadow-[inset_0_4px_8px_rgba(0,0,0,0.12),0_2px_4px_rgba(0,0,0,0.05),inset_0_1.5px_2px_rgba(255,255,255,0.95)] dark:shadow-[inset_0_6px_12px_rgba(0,0,0,0.65),0_1px_2px_rgba(255,255,255,0.08),inset_0_1px_1.5px_rgba(255,255,255,0.1)] transition-all duration-300 select-none ${
